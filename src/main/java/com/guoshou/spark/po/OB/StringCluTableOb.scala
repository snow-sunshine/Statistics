package com.guoshou.spark.po.OB
...
case class InsurApplString(
                            applId: String,
                            contactSeq: String,
                            custNo: String,
                            unevCustId: String,
                            contactShareFlag: String,
                            healthStatFlag: String,
                            applNo: String,
                            cgNo: String,
                            applType: String,
                            premFrom: String,
                            ...
                            bankaccName: String,
                            ernstPrem: String,
                            ernstMoneyinType: String,
                            ernstMoneyinDate: String,
                            moneyinType: String,
                            moneyinItrvl: String,
                            annDrawAge: String,
                            annAmnt: String,
                            ...
                            deratePct: String,
                            nextMoneyinDate: String,
                            derateFromDate: String
                          )

case class AmendGenInfoString(
                               mtnId: String,
                               cntrNo: String,
                               amendBranchNo: String,
                               amendDate: String,
                               amendSeq: String,
                               oldCntrNo: String,
                               polCode: String,
                               ...
                               applDate: String,
                               applBranchNo: String,
                               applClerkCode: String,
                               applEnterBranch: String,
                               applEnterClerk: String,
                               oclkBranchNo: String,
                               oclkClerkCode: String,
                               vclkBranchNo: String,
                               vclkClerkCode: String,
                               commitDate: String,
                               enterDate: String,
                               verifyDate: String,
                               applStat: String,
...
//case class MtnAltCntrString(
//                                 mtn_id: BigDecimal,
//                                 mtn_biz_no: String,
//                                 ipsn_no: BigDecimal,
//                                 mtn_item_code: String,
//                                 proc_stat: String,
//                                 proc_date: Option[java.sql.Date]
//                               )
