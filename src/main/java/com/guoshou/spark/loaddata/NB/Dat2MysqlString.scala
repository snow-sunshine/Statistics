...
import com.guoshou.spark.po.NB.{BizParameterString, BranchString, CntrSubStateString, EndowAccString, IfOfAltString, MioLogString, MtnAltCntrString, MtnOsmbShiftString, PlnmioRecString, PolicyString, StatisticsB1String, StatisticsB2String, StatisticsB3String, StdContractString, SvrGroupLstString, SvrGroupString}
import com.guoshou.spark.po._
import org.apache.spark.sql.{DataFrame, Dataset, SaveMode, SparkSession}

object Dat2MysqlString {
...
//    val statisticsB1Map: Dataset[StatisticsB1String] = statisticsB1DF.map(row => {
//      StatisticsB1String(
//        row.getString(0),
//        row.getString(1),
//        row.getString(2),
